...
public class VerifyOTPActivity extends AppCompatActivity {
    ...
    private  String strVerificationCode, strName, strMobileno, strEmailId, strUsername,strPasssword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strPasssword = getIntent().getStringExtra("password");
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etInputCode1.getText().toString().trim().isEmpty() ||
                    ...
                    return; // Exit the method if OTP is not fully entered
                }
    ...
    private void userRegistertbl() {
            ...
            params.put("password", strPasssword);
            ...
            client.post(Urls.registerUserWebService,
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    ...
                    try {
                        ...
                        {
                            progressDialog.dismiss();
                            Toast.makeText(VerifyOTPActivity.this,"Registration Success" , Toast.LENGTH_SHORT).show();
